...
public class LinkedListDeque61BTest {
    ...
    public void removefirsttest(){
        ...
        test.addFirst(2);
        test.addLast(3);
        int testnum = test.removeFirst();
        assertThat(test.toList()).containsExactly(1, 3).inOrder();
    ...
    public void removelasttest(){
        ...
        test.addFirst(2);
        test.addLast(3);
        int testnum = test.removeLast();
        assertThat(test.toList()).containsExactly(2, 1).inOrder();
        assertThat(testnum).isEqualTo(3);
        test.removeLast();
        test.removeLast();
        assertThat(test.isEmpty()).isTrue();
    }
    ...
    public void gettest(){
        ...
        assertThat(test.get(1111)).isEqualTo(null);
    }

    @Test
    public void regettest(){
        Deque61B<Integer> test = new LinkedListDeque61B<>();
        test.addLast(1);
        test.addFirst(2);
        test.addLast(3);
